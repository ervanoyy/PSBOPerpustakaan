      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="/Peminjaman/tambahpeminjamansantri/proses" method="POST" enctype="multipart/form-data" role="form">
             {{ csrf_field() }}
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">NIST</label>
                  <input type="text" class="form-control" placeholder="NIST" name="NIST">
                </div>
