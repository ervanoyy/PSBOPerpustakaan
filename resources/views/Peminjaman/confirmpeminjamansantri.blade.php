...
@section('content')
<title>Konfirmasi Peminjaman Santri Tahfidz</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        ...
        <li><a href="/peminjamansantri"></i> Siswa</a></li>
        <li><a href="/tambahpeminjamansantri">Form Peminjaman</a></li>
          ...
          <div class = "wrap">
            <div class = "card">
              ...
              <h2><b>Peminjaman Buku</b></h2>
                ...
                <tr>
                  <td width="80" align="left" valign="top">NIST</td>
              ...
              <div class = "container">
                <a href="/tambahpeminjamansantri" type="submit" class="btn btn-danger">Batal</a>
                <a href="/peminjamansantri" type="submit" class="btn btn-primary">Simpan</a>
              </div>
            </div>
            </div>
          </div>
