...
@section('content')
<title>Peminjaman Buku Santri</title>
      ...
      <div class="row">
        ...
        ?>
          ...
          <div class="box-header"> 
             <h3 class="box-title"><a href="/tambahpeminjamansantri" type="button" class="btn btn-block btn-success" id="tombol">+ Peminjaman Buku</a></h3>
             <h3 class="box-title pull-center"><a href="/peminjamansantri/export_excel" type="button" class="btn btn-block btn-success" id="tombol"> Export Data</a></h3>
             <h3 class="box-title pull-right"><a href="/peminjamansantri/deletesantri" type="button" class="btn btn-block btn-danger">Hapus Data</a></h3>
          </div>
