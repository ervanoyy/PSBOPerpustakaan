...
@section('content')
<title>Peminjaman Buku Pegawai</title>
      ...
      <div class="row">
        ...
        ?>
          ...
          <div class="box-header"> 
             <h3 class="box-title"><a href="/tambahpeminjamanpegawai" type="button" class="btn btn-block btn-success" id="tombol">+ Peminjaman Buku</a></h3>
             <h3 class="box-title pull-center"><a href="/peminjamanpegawai/export_excel" type="button" class="btn btn-block btn-success" id="tombol"> Export Data</a></h3>
             <h3 class="box-title pull-right"><a href="/peminjamanpegawai/deletepegawai" type="button" class="btn btn-block btn-danger">Hapus Data</a></h3>
          </div>
...
<div class="modal fade" id="pengembalian">
  ...
  <!-- Modal Content -->
            <div class="modal-content">
              ...
              <form action="/peminjamanpegawai/kembalikan" method="POST" id="kembaliForm">
                {{ csrf_field() }}
                <!-- {{ method_field('DELETE') }} -->
