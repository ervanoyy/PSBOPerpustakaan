...
<head>
  ...
  <title>Perpustakaan Baznas</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="https://adminlte.io/docs"><i class="fa fa-calendar"></i> <span>Kunjungan</span></a></li>
        <li><a href="https://adminlte.io/docs"><i class="fa fa-reply"></i> <span>Peminjaman</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
</aside>
